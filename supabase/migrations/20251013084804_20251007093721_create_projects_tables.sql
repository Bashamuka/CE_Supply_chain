...
DROP POLICY IF EXISTS "Admins can manage all project machines" ON project_machines;
...
DROP POLICY IF EXISTS "Users can view all project machines" ON project_machines;
...
DROP POLICY IF EXISTS "Admins can manage all machine parts" ON project_machine_parts;
...
DROP POLICY IF EXISTS "Users can view all machine parts" ON project_machine_parts;
...
DROP POLICY IF EXISTS "Admins can manage all supplier orders" ON project_supplier_orders;
...
DROP POLICY IF EXISTS "Users can view all supplier orders" ON project_supplier_orders;
...
DROP POLICY IF EXISTS "Admins can manage all project branches" ON project_branches;
...
DROP POLICY IF EXISTS "Users can view all project branches" ON project_branches;
...
DROP TRIGGER IF EXISTS update_project_machines_updated_at ON project_machines;
CREATE TRIGGER update_project_machines_updated_at
  BEFORE UPDATE ON project_machines
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_project_machine_parts_updated_at ON project_machine_parts;
