...
DROP POLICY IF EXISTS "Allow read access to authenticated users" ON parts_equivalence;
...
DROP POLICY IF EXISTS "Allow insert access to admin users" ON parts_equivalence;
...
DROP POLICY IF EXISTS "Allow update access to admin users" ON parts_equivalence;
...
DROP POLICY IF EXISTS "Allow delete access to admin users" ON parts_equivalence;
